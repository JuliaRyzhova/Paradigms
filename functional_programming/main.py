...
def pearson_correlation(numbers_1: List[float], numbers_2: List[float]) -> float:
    ...
    covariance = sum((numbers_1[i] - mean_1) *
                     (numbers_2[i] - mean_2) for i in range(n))
    variance_numbers_1 = sum((numbers_1i - mean_1)
                             ** 2 for numbers_1i in numbers_1)
    variance_numbers_2 = sum((numbers_2i - mean_2)
                             ** 2 for numbers_2i in numbers_2)
